...
Process Name: basic
PID: 8681
Date: 2014-12-09 12:40:55(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 8681, uid 5000)

Register Information
r0   = 0xe5977020, r1   = 0x00000001
r2   = 0x00000075, r3   = 0xe5977020
r4   = 0xb4428940, r5   = 0x00000001
r6   = 0xb6ad46e8, r7   = 0x004c0130
r8   = 0xbec9fde8, r9   = 0x000db668
r10  = 0xb4428940, fp   = 0xbec9fd04
ip   = 0xb2664bb0, sp   = 0xbec9fc38
lr   = 0xb42c44ff, pc   = 0xb42bd390
cpsr = 0x80000030
...
000dc000 0146d000 rw-p [heap]
ae4d5000 ae4da000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:8681)
Call Stack Count: 42
 0: (0xb42bd390) [/usr/lib/osp/libosp-appfw.so] + 0x1b1390
 1: Tizen::Locales::Calendar::GetTimeField(Tizen::Locales::TimeField) const + 0x16 (0xb42c44ff) [/usr/lib/osp/libosp-appfw.so] + 0x1b84ff
 2: CalendarViewerForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x34 (0xb2627fa8) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x15fa8
End of Call Stack
