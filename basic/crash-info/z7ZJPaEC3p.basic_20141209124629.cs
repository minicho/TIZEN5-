...
Process Name: basic
PID: 9053
Date: 2014-12-09 12:46:29(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 9053, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x0000235d
r2   = 0x00000006, r3   = 0x0000235d
r4   = 0x00000006, r5   = 0xb6be6be4
r6   = 0xb6be6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000db3b0
r10  = 0xb69f7000, fp   = 0xbec9fc5c
ip   = 0xb69f74c0, sp   = 0xbec9f638
...
Callstack Information (PID:9053)
Call Stack Count: 46
 ...
 4: Tizen::Locales::Calendar::GetTime() const + 0x36 (0xb42c44d3) [/usr/lib/osp/libosp-appfw.so] + 0x1b84d3
 5: CalendarViewerForm::UpdateCalendarDisplay() + 0x28 (0xb2626ba4) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x15ba4
 6: CalendarViewerForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x4ac (0xb2627420) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x16420
End of Call Stack
