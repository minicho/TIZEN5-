...
Process Name: basic
PID: 10601
Date: 2014-12-09 12:55:53(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 10601, uid 5000)

Register Information
r0   = 0x00000002, r1   = 0x00000001
r2   = 0x00000066, r3   = 0xb4428940
r4   = 0x0016b5fa, r5   = 0x00000001
r6   = 0x00000002, r7   = 0x002149b0
r8   = 0xbec9fd90, r9   = 0x000db708
r10  = 0xb4428940, fp   = 0xbec9fcac
ip   = 0xb2664aa0, sp   = 0xbec9fbe0
...
000dc000 00b05000 rw-p [heap]
ae4d4000 ae4d9000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:10601)
Call Stack Count: 44
 ...
 2: CalendarViewerForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x34 (0xb2626fa8) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x15fa8
End of Call Stack
