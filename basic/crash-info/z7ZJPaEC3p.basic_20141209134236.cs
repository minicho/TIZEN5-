...
Process Name: basic
PID: 14501
Date: 2014-12-09 13:42:36(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 14501, uid 5000)

Register Information
r0   = 0xbeca0010, r1   = 0x00000003
r2   = 0xbeca0010, r3   = 0xb4428940
r4   = 0xbeca0010, r5   = 0x005214f8
r6   = 0xbeca0010, r7   = 0x00000000
r8   = 0x00000003, r9   = 0x00000000
r10  = 0xbeca0294, fp   = 0xbeca0034
ip   = 0xb2664724, sp   = 0xbec9ff98
lr   = 0xb42c44b3, pc   = 0xb42bd462
cpsr = 0x60000030
...
Callstack Information (PID:14501)
Call Stack Count: 36
 0: (0xb42bd462) [/usr/lib/osp/libosp-appfw.so] + 0x1b1462
 1: Tizen::Locales::Calendar::GetTime() const + 0x16 (0xb42c44b3) [/usr/lib/osp/libosp-appfw.so] + 0x1b84b3
 2: EventListForm::GetEventList() + 0x28 (0xb2645c04) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x34c04
 3: EventListForm::OnSceneActivatedN(Tizen::Base::String const&, Tizen::Base::String const&, Tizen::Base::Collection::IList*) + 0x1b4 (0xb2644a38) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x33a38
End of Call Stack
