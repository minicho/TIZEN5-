...
Process Name: basic
PID: 15544
Date: 2014-12-10 13:59:13(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 15544, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003cb8
r2   = 0x00000006, r3   = 0x00003cb8
r4   = 0x00000006, r5   = 0xb6be6be4
r6   = 0xb6be6000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000db5e0
r10  = 0xb69f7000, fp   = 0xbec9fcac
ip   = 0xb69f74c0, sp   = 0xbec9f680
lr   = 0xb6aed55c, pc   = 0xb6ae9760
cpsr = 0x20000010
...
000dc000 0099c000 rw-p [heap]
ae55d000 ae562000 r-xp /usr/lib/libhaptic-module.so
aeee6000 aeef7000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
aef00000 aef05000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af323000 af326000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0b6e000 b0bb9000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b0bc2000 b0bea000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b0c19000 b0c1e000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
b0c27000 b0c31000 r-xp /usr/lib/libdrm-client.so.0.0.1
b0c39000 b0c63000 r-xp /usr/lib/libSLP-location.so.0.0.0
b0c6c000 b0c72000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.1.0
b0c7a000 b0c83000 r-xp /usr/lib/libdownload-provider-interface.so.1.1.6
b0c8b000 b0c9d000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b0ca5000 b0caa000 r-xp /usr/lib/libmmffile.so.0.0.0
b0cb2000 b0cb9000 r-xp /usr/lib/libmedia-utils.so.0.0.0
b0cc1000 b0cc3000 r-xp /usr/lib/libmedia-hash.so.1.0.0
b0ccb000 b0ce4000 r-xp /usr/lib/libmedia-thumbnail.so.1.0.0
b0cec000 b0cee000 r-xp /usr/lib/libmedia-svc-hash.so.1.0.0
b0cf6000 b0d0e000 r-xp /usr/lib/libmedia-service.so.1.0.0
b0d16000 b0d3c000 r-xp /usr/lib/libzmq.so.3.0.0
b0d46000 b0d4f000 r-xp /usr/lib/libpims-ipc.so.0.0.30
b0d57000 b0d5c000 r-xp /usr/lib/libmemenv.so.1.1.0
b0d64000 b0da2000 r-xp /usr/lib/libleveldb.so.1.1.0
b0dab000 b0db3000 r-xp /usr/lib/libgstfft-0.10.so.0.25.0
b0dbb000 b0de5000 r-xp /usr/lib/libgstaudio-0.10.so.0.25.0
b0dee000 b0dfd000 r-xp /usr/lib/libgstvideo-0.10.so.0.25.0
b0e05000 b0e1d000 r-xp /usr/lib/libgstpbutils-0.10.so.0.25.0
b0e1f000 b0e44000 r-xp /usr/lib/libxslt.so.1.1.16
b0e4d000 b0e51000 r-xp /usr/lib/libeukit.so.1.7.99
b0e59000 b0e61000 r-xp /usr/lib/libui-gadget-1.so.0.1.0
b0e69000 b0e74000 r-xp /usr/lib/libcapi-location-manager.so.0.1.11
b0e7c000 b0e7f000 r-xp /usr/lib/libcapi-telephony-network-info.so.0.1.0
b0e88000 b0e91000 r-xp /usr/lib/libcapi-system-sensor.so.0.1.17
b0e9a000 b0e9e000 r-xp /usr/lib/libcapi-web-url-download.so.0.1.0
b0ea6000 b0ebe000 r-xp /usr/lib/osp/libosp-locations.so.1.2.2.3
b0ebf000 b0ec4000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b0ecc000 b0eed000 r-xp /usr/lib/libcapi-content-media-content.so.0.2.59
b0ef5000 b0f09000 r-xp /usr/lib/libnetwork.so.0.0.0
b0f12000 b0f2b000 r-xp /usr/lib/libaccounts-svc.so.0.2.66
b0f33000 b0fa5000 r-xp /usr/lib/libcontacts-service2.so.0.9.114.7
b0fc4000 b1007000 r-xp /usr/lib/libcalendar-service2.so.0.1.44
b1011000 b1019000 r-xp /usr/lib/libcapi-web-favorites.so
b101a000 b221c000 r-xp /usr/lib/libewebkit2.so.0.11.113
b2301000 b231e000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2327000 b2341000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b234b000 b23a8000 r-xp /usr/lib/osp/libosp-content.so.1.2.2.0
b23b1000 b23c5000 r-xp /usr/lib/libwifi-direct.so.0.0
b23cd000 b23d5000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b23d6000 b23df000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b23e7000 b24a8000 r-xp /usr/lib/osp/libosp-social.so.1.2.2.0
b24b2000 b2527000 r-xp /usr/lib/osp/libosp-web.so.1.2.2.0
b2535000 b25fa000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2608000 b2612000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b261a000 b2662000 r-xp /opt/usr/apps/z7ZJPaEC3p/bin/basic.exe
...
Callstack Information (PID:15544)
Call Stack Count: 47
 0: gsignal + 0x3c (0xb6ae9760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6aed55c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6ae263c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x82 (0xb423ecef) [/usr/lib/osp/libosp-appfw.so] + 0x132cef
 4: Tizen::Locales::Calendar::GetTimeField(Tizen::Locales::TimeField) const + 0x34 (0xb42c451d) [/usr/lib/osp/libosp-appfw.so] + 0x1b851d
 5: CalendarViewerForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x34 (0xb262ff30) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x15f30
End of Call Stack
