...
Process Name: basic
PID: 16317
Date: 2014-12-10 14:07:04(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 16317, uid 5000)

Register Information
r0   = 0x000000ff, r1   = 0x00000001
r2   = 0x0000008d, r3   = 0xb4428940
r4   = 0x0016b5fa, r5   = 0x00000001
r6   = 0x000000ff, r7   = 0x00538768
r8   = 0xbec9fde8, r9   = 0x000db918
r10  = 0xb4428940, fp   = 0xbec9fd04
ip   = 0xb2664aa0, sp   = 0xbec9fc40
lr   = 0xb42c44ff, pc   = 0xb42bd33c
cpsr = 0x60000030
...
Callstack Information (PID:16317)
Call Stack Count: 42
 0: (0xb42bd33c) [/usr/lib/osp/libosp-appfw.so] + 0x1b133c
 1: Tizen::Locales::Calendar::GetTimeField(Tizen::Locales::TimeField) const + 0x16 (0xb42c44ff) [/usr/lib/osp/libosp-appfw.so] + 0x1b84ff
 2: CalendarViewerForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x34 (0xb262ff30) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x15f30
End of Call Stack
