...
Process Name: basic
PID: 17818
Date: 2014-12-10 14:21:40(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 17818, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x0039d4fc
r2   = 0x00000000, r3   = 0x0039d4fc
r4   = 0xb2664500, r5   = 0x0039d4f0
r6   = 0x0039d4fc, r7   = 0xb3d43d70
r8   = 0xa00009cb, r9   = 0xbec9f734
r10  = 0x00000006, fp   = 0xbec9f60c
ip   = 0xb374b745, sp   = 0xbec9f4c0
lr   = 0xb374b74f, pc   = 0xb3877054
cpsr = 0x60000030
...
000dc000 0092f000 rw-p [heap]
b0b3d000 b0b42000 r-xp /usr/lib/libhaptic-module.so
b0b4e000 b0b5f000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0b68000 b0b6d000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0bbf000 b0bc2000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b0bca000 b0bcb000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b0bd3000 b0bdd000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
...
b25ff000 b2608000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:17818)
Call Stack Count: 57
 0: (0xb3877054) [/usr/lib/osp/libosp-uifw.so] + 0x496054
 1: Tizen::Ui::Controls::EditField::AddActionEventListener(Tizen::Ui::IActionEventListener&) + 0xa (0xb374b74f) [/usr/lib/osp/libosp-uifw.so] + 0x36a74f
 2: ChatMain::OnInitializing() + 0x364 (0xb262d548) [/opt/apps/z7ZJPaEC3p/bin/basic.exe] + 0x1c548
 3: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb36a51a3) [/usr/lib/osp/libosp-uifw.so] + 0x2c41a3
 4: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x2e (0xb387fbc3) [/usr/lib/osp/libosp-uifw.so] + 0x49ebc3
 5: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb368c0af) [/usr/lib/osp/libosp-uifw.so] + 0x2ab0af
 6: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xfc (0xb368f969) [/usr/lib/osp/libosp-uifw.so] + 0x2ae969
 7: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x72 (0xb36924ef) [/usr/lib/osp/libosp-uifw.so] + 0x2b14ef
 8: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xac (0xb36b2051) [/usr/lib/osp/libosp-uifw.so] + 0x2d1051
 9: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb36867b7) [/usr/lib/osp/libosp-uifw.so] + 0x2a57b7
10: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3686843) [/usr/lib/osp/libosp-uifw.so] + 0x2a5843
End of Call Stack
