...
#ifndef _EDIT_EVENT_FORM_H_
#define _EDIT_EVENT_FORM_H_
...
private:
	...
	void LoadEvent(void);
	result UpdateEvent(void);

private:
	static const int ID_FOOTER_SAVE = 100;
	static const int ID_BUTTON_REMINDER = 200;
	static const int ID_BUTTON_RECURRENCE = 201;
	static const int ID_BUTTON_PRIORITY = 202;
	static const int ID_BUTTON_SENSITIVITY = 203;
	static const int ID_BUTTON_STATUS = 204;
	...
	static const int ID_CHKBUTTON_ISALLDAY_CHECKED = 500;
	static const int ID_CHKBUTTON_ISALLDAY_UNCHECKED = 501;
	...
	Tizen::Social::CalEvent* __pCalEvent;
